...
const SearchBar = (props) => {
  ...
  const newA = props.searchingStore.map((patient, index) => {
    newProps.push({ id: index, ...patient });
  });
  console.log(newA);
              ...
              {arrayUniqueByKey
                ? arrayUniqueByKey
                    ...
                    .map((eachPatient, index) => {
                      return (
                        <div className="patient_card" key={index}>
                          <Accordion>
                            <Accordion.Item eventKey={index}>
                              ...
                              <Accordion.Body className="each_patient_card">
                                <p>
                                  HKID: <span>{eachPatient.hkid}</span>
                                </p>
                                <p>
                                  E-mail: <span>{eachPatient.email}</span>
                                </p>
                                <p>
                                  Gender: <span>{eachPatient.gender}</span>
                                </p>
                                <p>
                                  Phone Number: <span>{eachPatient.phone}</span>
                                </p>
                                <p>
                                  Drug Allergies:
                                  <span> {eachPatient.drug_allergy}</span>
                                </p>
                              </Accordion.Body>
                            </Accordion.Item>
                          </Accordion>
